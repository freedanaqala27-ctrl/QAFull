...
def to_exercise_record(
    ...
    return {
        ...
        "solution_format": payload.get("solution_format", ""),
        "todo_start_marker": payload.get("todo_start_marker", ""),
        "todo_end_marker": payload.get("todo_end_marker", ""),
        "setup_code": payload.get("setup_code", ""),
        "public_tests_py": payload.get("public_tests_py", []),
        "hidden_tests_py": payload.get("hidden_tests_py", []),
        "surface_checks": payload.get("surface_checks", []),
        "timeout_seconds": payload.get("timeout_seconds"),
        "required_packages": payload.get("required_packages", []),
        "reference_solution_authority": payload.get("reference_solution_authority", ""),
